            ...
            <div className="flex items-center gap-4">
              <div className="flex flex-col gap-2">
                <div className={`flex items-center gap-1 sm:gap-2 min-w-0 ${i18n.language === 'ar' ? 'flex-row-reverse' : ''}`}>
                  ...
                  <a href="https://t.me/+4367846433933" target="_blank" rel="noopener noreferrer" className="hover:text-primary whitespace-nowrap text-sm" dir="ltr">+43 678 464 33933</a>
                </div>
                <div className={`flex items-center gap-1 sm:gap-2 min-w-0 ${i18n.language === 'ar' ? 'flex-row-reverse' : ''}`}>
                  {/* Telegram Icon - outline */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 sm:h-5 sm:w-5 text-primary" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <a href="https://t.me/+447308509557" target="_blank" rel="noopener noreferrer" className="hover:text-primary whitespace-nowrap text-sm" dir="ltr">+44 7308 509557</a>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <div className={`flex items-center gap-1 sm:gap-2 min-w-0 ${i18n.language === 'ar' ? 'flex-row-reverse' : ''}`}>
                  ...
                  <a href="https://wa.me/+4367846433933" target="_blank" rel="noopener noreferrer" className="hover:text-primary whitespace-nowrap text-sm" dir="ltr">+43 678 464 33933</a>
                </div>
                <div className={`flex items-center gap-1 sm:gap-2 min-w-0 ${i18n.language === 'ar' ? 'flex-row-reverse' : ''}`}>
                  {/* WhatsApp Icon (brand) */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 sm:h-5 sm:w-5 text-primary" aria-hidden="true" focusable="false" fill="currentColor">
                  ...
                  <a href="https://wa.me/+447308509557" target="_blank" rel="noopener noreferrer" className="hover:text-primary whitespace-nowrap text-sm" dir="ltr">+44 7308 509557</a>
                </div>
              </div>
            </div>
          </CardContent>
