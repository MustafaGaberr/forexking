        ...
        <Card className="w-full bg-card border border-border rounded-2xl shadow-lg">
          <CardContent className="flex flex-col items-center gap-5 md:gap-6 p-6 text-foreground">
            <div className="flex items-center gap-4">
              ...
              <a href="mailto:contact@forexking.info" className="hover:text-primary">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="flex items-center gap-4">
                ...
                <a href="tel:+15075288062" className="hover:text-primary">
                  +1 507 528 8062
                </a>
              </div>
            <div className="flex items-center gap-4">
              {/* WhatsApp Icon (brand) with same style */}
              <svg
              ...
              <a href="https://wa.me/+4367846433933" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                +43 678 464 33933
              </a>
            </div>
            </div>
