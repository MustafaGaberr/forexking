        ...
        <div className={`mb-8 ${isArabic ? 'text-right' : 'text-left'}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              {/* WhatsApp Button */}
              <a
                href={`https://wa.me/${phoneNumbers[0].replace(/\+/g, '')}`}
                target="_blank"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-1.5">
                  ...
                  <span className="text-sm font-semibold leading-tight text-center">{phoneNumbers[0]}</span>
                </div>
              </a>
              
              {/* Telegram Button */}
              <a
                href={`https://t.me/${phoneNumbers[0].replace(/\+/g, '')}`}
                target="_blank"
                rel="noopener noreferrer"
