                    ...
                    <div className="flex-1 space-y-3 text-sm sm:text-base">
                      ...
                      <div className="flex flex-wrap items-center gap-2 text-sm">
                        <span className="text-gray-600 dark:text-gray-300 font-medium">
                          {i18n.language === 'ar' ? ' عبر الواتساب او تيليجرام:' : 'Via WhatsApp or Telegram:'}
                        </span>
                        <a 
                        ...
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-green-300 font-semibold transition-colors"
                        >
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M22 2L11 13" />
